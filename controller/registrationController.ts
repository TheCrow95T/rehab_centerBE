...
export const getRegistrationSummaryList = async (
  ...
  try {
    ...
    const queryString = [
      "SELECT to_char(treatment_date,'YYYY-MM-DD') as treatment_date, timeslot_id, start_time, end_time,COUNT(*) as population",
      ...
      "GROUP BY treatment_date, start_time, end_time, timeslot_id",
